...
const bridge: ConductorBridge = {
  ...
  remote: {
    ...
    invite: () => ipcRenderer.invoke('remote:invite'),
    ...
    createRemoteProject: (machineId, name) => ipcRenderer.invoke('remote:create-remote-project', machineId, name),
    unshareProject: (peerId, projectId) => ipcRenderer.invoke('remote:unshare-project', peerId, projectId),
  ...
  updates: {
    ...
    versions: () => ipcRenderer.invoke('updates:versions'),
    pinVersion: (version, pinned) => ipcRenderer.invoke('updates:pin-version', version, pinned),
    restorePlan: (version, scope) => ipcRenderer.invoke('updates:restore-plan', version, scope),
    rollback: (version, scope) => ipcRenderer.invoke('updates:rollback', version, scope),
    cliPins: () => ipcRenderer.invoke('updates:cli-pins'),
    useInstalledClis: () => ipcRenderer.invoke('updates:use-installed-clis'),
