...
export const SCHEDULE_KINDS = ['agent', 'latest-models-methods'] as const
export type ScheduleKind = (typeof SCHEDULE_KINDS)[number]
export const BUILTIN_SCHEDULE_KINDS: ReadonlyArray<Exclude<ScheduleKind, 'agent'>> = ['latest-models-methods']
