...
import { Archive, ArrowDown, ArrowLeft, FileDiff, FilePlus2, GitBranch, Globe2, History, ListTree, Pin, Play, PlugZap, Settings2, Telescope, TerminalSquare, MessagesSquare, LoaderCircle, X } from 'lucide-react'
