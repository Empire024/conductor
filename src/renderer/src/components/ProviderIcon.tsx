...
// The locally served models are Qwen builds, so Local wears the same mark.
const icons: Record<string, string> = { codex: openai, openai, claude, gemini, qwen, kimi, local: qwen }
const labels: Record<string, string> = { codex: 'OpenAI', openai: 'OpenAI', claude: 'Claude', gemini: 'Gemini', qwen: 'Qwen', kimi: 'Kimi', local: 'Local' }
