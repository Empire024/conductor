export const SETTINGS_SECTIONS = [
  ...
  { id: 'usage', title: 'Usage', description: 'Set a default limit for your conversations.', keywords: 'usage cap allowance weekly short rolling window tokens budget account points consumed measured against' },
