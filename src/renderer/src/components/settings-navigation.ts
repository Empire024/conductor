export const SETTINGS_SECTIONS = [
  ...
  { id: 'machines', title: 'Machines', description: 'Connect your computers and control them from here.', keywords: 'remote control account machines github sign in invite device pairing relay tailscale advanced always on login startup start at login sleep power unattended auto sign-in reboot' },
