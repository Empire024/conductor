...
- [ ] When a project is closed in projects view & something is running in one workspace, but another workspace has been finished for a while, then we closed conductor, so it shows yellow as disconnected -> in this case, the closed project shows yellow and doesn't show blue (active) . Only clicking on the project shows blue.. <!-- conductor-task:c3070e39-1784-4c48-863e-43a76059fee3 -->
...
- [ ] The Effort: Account default has to always translate to something for Claude and Codex - do not show the Owner 'Account default' literally, we need to have ways to find out what Effort it actually is. <!-- conductor-task:d0b9a61a-f415-4939-9ec1-7c9dc1dac182 -->
