...
- [ ] Visually [on Conductor side, without wasting tokens] show when agent uses Conductor: a tab was called & also visually show what actions the tab took (controlling tabs, making decisions, using conductor, restarting, etc.) <!-- conductor-task:44a4ba26-0ec7-4d40-a1d9-c2634b3b7206 -->
