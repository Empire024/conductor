...
| Real-model 6-hour unattended soak (`--fixture=crossref`, several context rollovers expected) | `DURABLE_SMOKE_TIMEOUT_MS=21600000 node scripts/smoke-lock.mjs -- node scripts/smoke-durable-jobs.mjs --real-model --fixture=crossref --extras=none` | 2026-09-24T21:2xZ | *pending* | `artifacts/durable-jobs/acceptance-2026-09-24/real-model-soak.log` | *running in the background; this row is updated when it settles (capped at 6h)* | |
